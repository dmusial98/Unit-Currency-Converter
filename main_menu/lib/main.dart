...
// if(test2.isEmpty || test2.length == 0)
// {
  ...
  await unitMeasureDao.insertUnitMeasure(UnitMeasureDB(null, "dekagram", "dag", 1, "dag = g / 10", "g = dag * 10", 0));
  ...
  await unitMeasureDao.insertUnitMeasure(UnitMeasureDB(null, "hektometr", "hm", 2, "hm = m / 100", "m = hm * 100", 0));

  await unitMeasureDao.insertUnitMeasure(UnitMeasureDB(null, "sekunda", "s", 3, "s = m * 60", "m = s / 60", 0));
